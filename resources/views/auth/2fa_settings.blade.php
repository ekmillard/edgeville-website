    ...
    <div class="container super-narrow">
        <div class="wrapper p-4 p-lg-5">
            <div class="content-area">
                ...
                <p>Two factor authentication (2FA) strengthens access security by requiring two methods (also referred
                ...
                @if($data['user']->twoFactorSecurity == null)
                ...
                @elseif(!$data['user']->twoFactorSecurity->google2fa_enable)
